...
export const useBankStore = defineStore("bank", () => {
  ...
  const banks = ref([
    {
      name: '멀티캠퍼스 역삼',
      image: '/src/assets/icons/ssafy-logo.png',
    ...
    },
    {
      ...
      image: '/src/assets/icons/banks/gookmin-logo.svg',
    ...
    },
    {
      ...
      image: '/src/assets/icons/banks/shinhan-logo.svg',
    ...
    {
      name: '우리은행 GS타워금융센터',
      image: '/src/assets/icons/banks/woori-logo.svg',
    ...
    {
      name: '제주은행 서울',
      image: '/src/assets/icons/banks/jeju-logo.svg',
    ...
    },
    {
      ...
      image: '/src/assets/icons/banks/ibk-logo.svg',
    ...
    {
      name: '하나은행 강남중앙지점',
      image: '/src/assets/icons/banks/hana-logo.svg',
    ...
    {
      name: '한국은행 강남본부',
      image: '/src/assets/icons/banks/korea-logo.svg',
  ...
  const selectedLocation = computed(() => {
    return locations.value.find(location => location.name === currentLocation.value.name);
  });
  ...
  const changeLocation = (bank) => {
    ...
    nmap.value.fitBounds(new naver.maps.LatLngBounds(
